    ...
    [
        ...
        'variables' => [
            ...
            [
                ...
                'description' => 'Select default storage device. The default value is \'local\'. List of supported adapters are \'local\', \'s3\', \'dospaces\', \'backblaze\', \'linode\' , \'wasabi\' and \'minio\'.',
                'introduction' => '0.13.0',
                'default' => 'local',
                'required' => false,
                'question' => '',
            ...
            [
                'name' => '_APP_STORAGE_MINIO_ACCESS_KEY',
                'description' => 'MinIO access key. Required when the storage adapter is set to MinIO. You can get your access key from your MinIO console.',
                'introduction' => '0.14.2',
                'default' => '',
                'required' => false,
                'question' => '',
            ...
            [
                'name' => '_APP_STORAGE_MINIO_SECRET',
                'description' => 'MinIO secret key. Required when the storage adapter is set to MinIO. You can get your secret key from your MinIO console.',
                'introduction' => '0.14.2',
                'default' => '',
                'required' => false,
                'question' => '',
            ...
            [
                'name' => '_APP_STORAGE_MINIO_REGION',
                'description' => 'MinIO region. Required when storage adapter is set to MinIO. You can find your region info from your MinIO console.',
                'introduction' => '0.14.2',
                'default' => 'eu-central-1',
                'required' => false,
                'question' => '',
            ...
            [
                'name' => '_APP_STORAGE_MINIO_HOST',
                'description' => 'MinIO bucket. Required when storage adapter is set to MinIO. You can create buckets in your MinIO console.',
                'introduction' => '0.14.2',
                'default' => '',
                'required' => false,
                'question' => '',
            ...
            [
                'name' => '_APP_STORAGE_MINIO_BUCKET',
                'description' => 'MinIO bucket. Required when storage adapter is set to MinIO. You can create buckets in your MinIO console.',
                'introduction' => '0.14.2',
                'default' => '',
                'required' => false,
